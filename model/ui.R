...
shinyUI(fluidPage(
  ...
  sidebarLayout(
    sidebarPanel(
      ...
      sliderInput('spend_fb',"Enter Facebook Spend",min=0,max=100000,value=1000,ticks=TRUE,step=5000),
      sliderInput('spend_gg',"Enter Google/YMSN Spend",min=0,max=100000,value=1000,ticks=TRUE,step=5000),
      sliderInput('spend_tr',"Enter Transit Spend",min=0,max=100000,value=1000,ticks=TRUE,step=5000),
      sliderInput('spend_tv',"Enter TV Spend",min=0,max=100000,value=1000,ticks=TRUE,step=5000),
